...
presented during the original experiment was more rough. The two plots in
...
\begin{figure*}
  ...
  \caption{Model-recovered versus actual Einstein radii \ERf[,rec] and
    \ERf[,act].
%    Circles denote models where the image parities and
...
with standard deviation 8\% (the dark grey band in \Figref{ER_per_sim}).
