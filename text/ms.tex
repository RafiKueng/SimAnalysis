...
\tgeom(x,y) \propto x^2 + y^2 \,.
\end{equation}

\begin{equation} \label{eq:tgrav}
\tgrav = \langle \tgrav^{\textstyle\circ} \rangle
         + (1+z_L) \frac{2G}{c^3} M_{\textstyle\bullet}
\end{equation}
...
\begin{figure}
\centering
%\includegraphics[height=.3\vsize]{fig/arriv_0}
%\includegraphics[height=.3\vsize]{fig/arriv_1}
%\includegraphics[height=.3\vsize]{fig/arriv_2}
...
\begin{figure}
  ...
  \includegraphics[width=\myplotswidth]{fig/ASW000102p_arriv} 
  \includegraphics[width=\myplotswidth]{fig/006941_spaghetti} \\
  \includegraphics[width=\myplotswidth]{fig/ASW000102p_kappa}
...
\begin{figure}
  ...
  \includegraphics[width=\myplotswidth]{fig/ASW000195x_arriv.png}
  \includegraphics[width=\myplotswidth]{fig/006975_spaghetti} \\
  \includegraphics[width=\myplotswidth]{fig/ASW000195x_kappa.png}
...
\begin{figure}
  ...
  \includegraphics[width=\myplotswidth]{fig/ASW0000vqg_arriv}
  \includegraphics[width=\myplotswidth]{fig/006937_spaghetti} \\
  \includegraphics[width=\myplotswidth]{fig/ASW0000vqg_kappa}
...
\end{figure}
  ...
  %\includegraphics[width=\myplotswidth]{fig/00_input}
  %\includegraphics[width=\myplotswidth]{fig/00_arr_time} \\
  %\includegraphics[width=\myplotswidth]{fig/ASW000_arriv}
  %\includegraphics[width=\myplotswidth]{fig/00_spaghetti} \\
  %\includegraphics[width=\myplotswidth]{fig/ASW000_kappa}
  %\includegraphics[width=\myplotswidth]{fig/00_mass}
...
\begin{figure}
  ...
  \includegraphics[width=\myplotswidth]{fig/ASW0004oux_arriv}
  \includegraphics[width=\myplotswidth]{fig/006990_spaghetti} \\
  \includegraphics[width=\myplotswidth]{fig/ASW0004oux_kappa}
...
\begin{figure}
  ...
  \includegraphics[width=\myplotswidth]{fig/ASW0001hpf_arriv}
  \includegraphics[width=\myplotswidth]{fig/006915_spaghetti} \\
  \includegraphics[width=\myplotswidth]{fig/ASW0001hpf_kappa}
...
\begin{figure}
  ...
  \includegraphics[width=\myplotswidth]{fig/ASW0000h2m_arriv}
  \includegraphics[width=\myplotswidth]{fig/007022_spaghetti} \\
  \includegraphics[width=\myplotswidth]{fig/ASW0000h2m_kappa}
...
\begin{figure}
  ...
  \includegraphics[width=\myplotswidth]{fig/ASW0002z6f_arriv}
  \includegraphics[width=\myplotswidth]{fig/006919_spaghetti} \\
  \includegraphics[width=\myplotswidth]{fig/ASW0002z6f_kappa}
...
Recall \cite{1986ApJ...310..568B} and specifically their
equations (2.1) to (2.6).  We can rewrite those as
