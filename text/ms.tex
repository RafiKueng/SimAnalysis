...
\begin{figure*}
  ...
  \subfigure[real vs model enclosed mass]{
    \label{fig:6941_kappa}
    \includegraphics[width=0.15\linewidth]{fig/006941_input}
  }
  \subfigure[model lensed image]{
    \label{fig:6941_atime}
...
\begin{figure*}
  ...
  \subfigure[real vs model enclosed mass]{
    ...
    \includegraphics[width=0.15\linewidth]{fig/006975_input}
  }
  \subfigure[model lensed image]{
...
\begin{figure*}
  ...
  \subfigure[real vs model enclosed mass]{
    ...
    \includegraphics[width=0.15\linewidth]{fig/006937_input}
  }
  \subfigure[model lensed image]{
...
\begin{figure*}
  ...
  \subfigure[real vs model enclosed mass]{
    ...
    \includegraphics[width=0.15\linewidth]{fig/006990_input}
  }
  \subfigure[model lensed image]{
...
\begin{figure*}
  ...
  \subfigure[real vs model enclosed mass]{
    ...
    \includegraphics[width=0.15\linewidth]{fig/006915_input}
  }
  \subfigure[model lensed image]{
...
\begin{figure*}
  ...
  \subfigure[real vs model enclosed mass]{
    ...
    \includegraphics[width=0.15\linewidth]{fig/007022_input}
  }
  \subfigure[model lensed image]{
...
\begin{figure*}
  ...
  \subfigure[real vs model enclosed mass]{
    ...
    \includegraphics[width=0.15\linewidth]{fig/007025_input}
  }
  \subfigure[model lensed image]{
...
\begin{figure*}
  ...
  \subfigure[real vs model enclosed mass]{
    ...
    \includegraphics[width=0.15\linewidth]{fig/006919_input}
  }
  \subfigure[model lensed image]{
