...
\begin{figure}[h]
\centering
\includegraphics[width=.7\hsize]{fig/lenssky.pdf}
...
\begin{figure}
  ...
  \subfigure[real vs model enclosed mass]{
    ...
    \includegraphics[width=0.45\textwidth]{fig/006941_kappa_encl.pdf}
  }
...
\begin{figure}
  ...
  \subfigure[real vs model enclosed mass]{
    ...
    \includegraphics[width=0.45\textwidth]{fig/006975_kappa_encl.pdf}
  }
  \subfigure[model lensed image]{
...
\begin{figure}
  ...
  \subfigure[real vs model enclosed mass]{
    ...
    \includegraphics[width=0.45\textwidth]{fig/006937_kappa_encl.pdf}
  }
  \subfigure[model lensed image]{
...
\begin{figure}
  ...
  \subfigure[real vs model enclosed mass]{
    ...
    \includegraphics[width=0.45\textwidth]{fig/006990_kappa_encl.pdf}
  }
  \subfigure[model lensed image]{
...
\begin{figure}
  ...
  \subfigure[real vs model enclosed mass]{
    ...
    \includegraphics[width=0.45\textwidth]{fig/006915_kappa_encl.pdf}
  }
  \subfigure[model lensed image]{
...
\begin{figure}
  ...
  \subfigure[real vs model enclosed mass]{
    ...
    \includegraphics[width=0.45\textwidth]{fig/007022_kappa_encl.pdf}
  }
  \subfigure[model lensed image]{
...
\begin{figure}
  ...
  \subfigure[real vs model enclosed mass]{
    ...
    \includegraphics[width=0.45\textwidth]{fig/007025_kappa_encl.pdf}
  }
  \subfigure[model lensed image]{
...
\begin{figure}
  ...
  \subfigure[real vs model enclosed mass]{
    ...
    \includegraphics[width=0.45\textwidth]{fig/006919_kappa_encl.pdf}
  }
  \subfigure[model lensed image]{
...
\begin{figure}
  \centering
  \subfigure{\includegraphics[width=0.45\textwidth]
             {fig/007020_kappa_encl.pdf}}
  \subfigure{\includegraphics[width=0.45\textwidth]
             {fig/007024_kappa_encl.pdf}}
  \subfigure{\includegraphics[width=0.45\textwidth]
             {fig/007021_kappa_encl.pdf}} \\
