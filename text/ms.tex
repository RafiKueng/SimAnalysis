...
\begin{figure}
\centering
\includegraphics[width=1.1\linewidth]{fig/arriv1}
\includegraphics[width=1.1\linewidth]{fig/arriv2}
\includegraphics[width=1.1\linewidth]{fig/arriv3}
...
\begin{figure}
  \centering
  \subfigure{\includegraphics[width=0.9\hsize]
             {fig/006941_input}} \\
  \subfigure{\includegraphics[width=0.9\hsize]
             {fig/007022_input}} \\
  \subfigure{\includegraphics[width=0.9\hsize]
...
% Phil's one row design
\begin{figure*}
  \centering
  \subfigure[real mass distribution]{
    \label{fig:6941_sim_mass}
    \includegraphics[width=0.15\linewidth]{fig/ASW000102p_kappa}
  }
  \subfigure[real arrival-time surface]{
    \label{fig:6941_sim_arr}
    \includegraphics[width=0.15\linewidth]{fig/ASW000102p_arriv}
  }
  \subfigure[model mass distribution]{
    \label{fig:6941_mass}
    \includegraphics[width=0.15\linewidth]{fig/006941_mass}
  }
  \subfigure[model arrival-time surface]{
    \label{fig:6941_cont}
    \includegraphics[width=0.15\linewidth]{fig/006941_spaghetti}
  }
  \subfigure[real vs model enclosed mass]{
    \label{fig:6941_kappa}
    \includegraphics[width=0.15\linewidth]{fig/006941_kappa_encl}
  }
  \subfigure[model lensed image]{
    \label{fig:6941_atime}
    \includegraphics[width=0.15\linewidth]{fig/006941_arr_time}
  }
  \caption[result 6941 (ASW000102p)]{Model results for a simple
    simulated lens.  (The label ASW000102p in the lower-left panel is
    the \sw identifier for the sky patch where this sim was placed.)
...
% Convert all to Phil's scheme:
\begin{figure*}
  \centering
  \subfigure[real mass distribution]{
    \label{fig:6975_sim_mass}
    \includegraphics[width=0.15\linewidth]{fig/ASW000195x_kappa}
  }
  \subfigure[real arrival-time surface]{
    \label{fig:6975_sim_arr}
    \includegraphics[width=0.15\linewidth]{fig/ASW000195x_arriv}
  }
  \subfigure[model mass distribution]{
    \label{fig:6975_mass}
    \includegraphics[width=0.15\linewidth]{fig/006975_mass}
  }
  \subfigure[model arrival-time surface]{
    \label{fig:6975_cont}
    \includegraphics[width=0.15\linewidth]{fig/006975_spaghetti}
  }
  \subfigure[real vs model enclosed mass]{
    \label{fig:6975_kappa}
    \includegraphics[width=0.15\linewidth]{fig/006975_kappa_encl}
  }
  \subfigure[model lensed image]{
    \label{fig:6975_atime}
    \includegraphics[width=0.15\linewidth]{fig/006975_arr_time}
  }
...
\begin{figure*}
  ...
  \subfigure[real mass distribution]{
    ...
    \includegraphics[width=0.15\linewidth]{fig/ASW0000vqg_kappa}
  }
  \subfigure[real arrival-time surface]{
    \label{fig:6937_sim_arr}
    \includegraphics[width=0.15\linewidth]{fig/ASW0000vqg_arriv}
  }
  \subfigure[model mass distribution]{
    \label{fig:6937_mass}
    \includegraphics[width=0.15\linewidth]{fig/006937_mass}
  }
  \subfigure[model arrival-time surface]{
    \label{fig:6937_cont}
    \includegraphics[width=0.15\linewidth]{fig/006937_spaghetti}
  }
  \subfigure[real vs model enclosed mass]{
    \label{fig:6937_kappa}
    \includegraphics[width=0.15\linewidth]{fig/006937_kappa_encl}
  }
  \subfigure[model lensed image]{
    \label{fig:6937_atime}
    \includegraphics[width=0.15\linewidth]{fig/006937_arr_time}
  }
...
\begin{figure*}
  ...
  \subfigure[real mass distribution]{
    ...
    \includegraphics[width=0.15\linewidth]{fig/ASW0004oux_kappa}
  }
  \subfigure[real arrival-time surface]{
    \label{fig:6990_sim_arr}
    \includegraphics[width=0.15\linewidth]{fig/ASW0004oux_arriv}
  }
  \subfigure[model mass distribution]{
    \label{fig:6990_mass}
    \includegraphics[width=0.15\linewidth]{fig/006990_mass}
  }
  \subfigure[model arrival-time surface]{
    \label{fig:6990_cont}
    \includegraphics[width=0.15\linewidth]{fig/006990_spaghetti}
  }
  \subfigure[real vs model enclosed mass]{
    \label{fig:6990_kappa}
    \includegraphics[width=0.15\linewidth]{fig/006990_kappa_encl}
  }
  \subfigure[model lensed image]{
    \label{fig:6990_atime}
    \includegraphics[width=0.15\linewidth]{fig/006990_arr_time}
  }
...
\begin{figure*}
  ...
  \subfigure[real mass distribution]{
    ...
    \includegraphics[width=0.15\linewidth]{fig/ASW0001hpf_kappa}
  }
  \subfigure[real arrival-time surface]{
    \label{fig:6915_sim_arr}
    \includegraphics[width=0.15\linewidth]{fig/ASW0001hpf_arriv}
  }
  \subfigure[model mass distribution]{
    \label{fig:6915_mass}
    \includegraphics[width=0.15\linewidth]{fig/006915_mass}
  }
  \subfigure[model arrival-time surface]{
    \label{fig:6915_cont}
    \includegraphics[width=0.15\linewidth]{fig/006915_spaghetti}
  }
  \subfigure[real vs model enclosed mass]{
    \label{fig:6915_kappa}
    \includegraphics[width=0.15\linewidth]{fig/006915_kappa_encl}
  }
  \subfigure[model lensed image]{
    \label{fig:6915_atime}
    \includegraphics[width=0.15\linewidth]{fig/006915_arr_time}
  }
...
\begin{figure*}
  ...
  \subfigure[real mass distribution]{
    ...
    \includegraphics[width=0.15\linewidth]{fig/ASW0000h2m_kappa}
  }
  \subfigure[real arrival-time surface]{
    \label{fig:7022_sim_arr}
    \includegraphics[width=0.15\linewidth]{fig/ASW0000h2m_arriv}
  }
  \subfigure[model mass distribution]{
    \label{fig:7022_mass}
    \includegraphics[width=0.15\linewidth]{fig/007022_mass}
  }
  \subfigure[model arrival-time surface]{
    \label{fig:7022_cont}
    \includegraphics[width=0.15\linewidth]{fig/007022_spaghetti}
  }
  \subfigure[real vs model enclosed mass]{
    \label{fig:7022_kappa}
    \includegraphics[width=0.15\linewidth]{fig/007022_kappa_encl}
  }
  \subfigure[model lensed image]{
    \label{fig:7022_atime}
    \includegraphics[width=0.15\linewidth]{fig/007022_arr_time}
  }
...
\begin{figure*}
  ...
  \subfigure[model mass distribution]{
    \label{fig:7025_mass}
    \includegraphics[width=0.15\linewidth]{fig/007025_mass}
  }
  \subfigure[model arrival-time surface]{
    \label{fig:7025_cont}
    \includegraphics[width=0.15\linewidth]{fig/007025_spaghetti}
  }
  \subfigure[real vs model enclosed mass]{
    \label{fig:7025_kappa}
    \includegraphics[width=0.15\linewidth]{fig/007025_kappa_encl}
  }
  \subfigure[model lensed image]{
    \label{fig:7025_atime}
    \includegraphics[width=0.15\linewidth]{fig/007025_arr_time}
  }

  \caption[result 7025 (ASW0000h2m)]{Another model for the lens
    appearing in \figref{7022}.  The image parities in this case
...
\begin{figure*}
  ...
  \subfigure[real mass distribution]{
    ...
    \includegraphics[width=0.15\linewidth]{fig/ASW0002z6f_kappa}
  }
  \subfigure[real arrival-time surface]{
    \label{fig:6919_sim_arr}
    \includegraphics[width=0.15\linewidth]{fig/ASW0002z6f_arriv}
  }
  \subfigure[model mass distribution]{
    \label{fig:6919_mass}
    \includegraphics[width=0.15\linewidth]{fig/006919_mass}
  }
  \subfigure[model arrival-time surface]{
    \label{fig:6919_cont}
    \includegraphics[width=0.15\linewidth]{fig/006919_spaghetti}
  }
  \subfigure[real vs model enclosed mass]{
    \label{fig:6919_kappa}
    \includegraphics[width=0.15\linewidth]{fig/006919_kappa_encl}
  }
  \subfigure[model lensed image]{
    \label{fig:6919_atime}
    \includegraphics[width=0.15\linewidth]{fig/006919_arr_time}
  }
...
\begin{figure*}
  \centering
    \includegraphics[width=0.90\linewidth]{fig/eR_4}
