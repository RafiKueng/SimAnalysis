...
(EB, CC, CM, JO, PSand JW) until the modelling stage was done.

\subsection{Some example models} \label{sec:example_models}

Of the 119 models proposed, we discuss now present eight examples in
some detail.  Results from these are shown in Figures
...
\secref{SpaghettiLens}.  These derive from the mean of an ensemble
