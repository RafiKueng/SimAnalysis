...
these, at a conceptual level, without implementation details.
...
saddle-point contours.  Examples appear in Figures \ref{fig:6941} to
\ref{fig:7022} below (upper-left panel in each case).
