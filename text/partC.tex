...
Sections~\ref{ref:Fermat} and \ref{sec:arriv} omitted some details for
the sake of a more intuitive explanation.  Specifically, the geometric
time delay $t_{\rm geom}$ and the convergence $\kappa$ were left as
proportionalities (equations
