...
\end{equation}
The total line-of-sight comoving distance is then given by
\begin{equation}
\begin{aligned}
&D_S    &                                &\int_0^{z_S} \\
\noalign{\medskip}
...
Then the comoving distances $D$ can be written as function of the angular-diameter distances
$d$ by:
\begin{equation}
\begin{aligned}
D_S &= (1+z_S) \, d_S \\
