...
The first modelling step with \spl is for the user to call up the \sw
...
saddle-point contours.  Figure \ref{fig:input-spag} shows some example
...
are necessary.  GLASS uses a prior based on suggestions by by
