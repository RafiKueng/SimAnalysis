...
\begin{figure}
  \centering
  \subfigure{\includegraphics[width=0.45\textwidth]{fig/sims/006941/input.png}}
  \subfigure{\includegraphics[width=0.45\textwidth]{fig/sims/007022/input.png}}
  \subfigure{\includegraphics[width=0.45\textwidth]{fig/sims/006919/input.png}}
%  \includegraphics[width=.45\textsize]{fig/spag6941.png}
%  \includegraphics[width=.45\textsize]{fig/spag7022.png}
%  \includegraphics[width=.45\textsize]{fig/spag6919.png}
